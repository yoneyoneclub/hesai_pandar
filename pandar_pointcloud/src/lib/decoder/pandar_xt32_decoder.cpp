...
#include "pandar_pointcloud/decoder/pandar_xt32.hpp"
...
{
PandarXT32Decoder::PandarXT32Decoder(rclcpp::Node & node, Calibration& calibration, float scan_phase, double dual_return_distance_threshold, ReturnMode return_mode)
...
bool PandarXT32Decoder::hasScanned()
{
  return has_scanned_;
}

PointcloudXYZIRADT PandarXT32Decoder::getPointcloud()
{
  return scan_pc_;
}

void PandarXT32Decoder::unpack(const pandar_msgs::msg::PandarPacket& raw_packet)
{
...
PointcloudXYZIRADT PandarXT32Decoder::convert(const int block_id)
{
...
PointcloudXYZIRADT PandarXT32Decoder::convert_dual(const int block_id)
{
  PointcloudXYZIRADT block_pc(new pcl::PointCloud<PointXYZIRADT>);
...
bool PandarXT32Decoder::parsePacket(const pandar_msgs::msg::PandarPacket& raw_packet)
{
